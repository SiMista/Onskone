...
export const fr: Dictionary = {
  ...
  themePicker: {
    ...
    counter: (n, total) => `${n} / ${total} activés`,
  ...
  phases: {
    ...
    guessing: {
      ...
      instructionMobile: 'Tape une réponse puis un joueur',
      instructionDesktop: 'Glisse chaque réponse vers son auteur présumé',
      assignWaiting: 'assigne les réponses…',
      answers: 'Réponses',
      allAssigned: 'Toutes les réponses ont été attribuées',
      tapToAssign: 'Tape pour assigner',
      dropHere: 'Dépose ici',
