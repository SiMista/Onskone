        ...
        <div className="w-full flex flex-col gap-2">
            ...
            <div className="relative flex flex-col md:grid md:grid-cols-3 gap-1.5">
                {categories.map(cat => {
                    ...
                    return (
                        <div key={cat} className="border-2 border-black rounded-lg w-full bg-white/80 min-w-0 overflow-hidden">
                            <div
                                className="flex items-center gap-1 px-2 py-1.5 cursor-pointer select-none transition-opacity hover:opacity-90"
                            ...
                            >
                                ...
                                <span className="text-[10px] text-black/70 whitespace-nowrap flex-shrink-0">
                            ...
                            {isOpen && (
                                <div className="md:hidden animate-menu-open bg-white border-t-2 border-black max-h-[40vh] overflow-y-auto">
                                    {description && (
                                        <div className="px-2 py-1.5 text-[11px] italic text-gray-600 border-b border-black/20">
                                            {description}
                                        </div>
                                    )}
                ...
                {openCategory && (() => {
                    ...
                    const description = categoryDescriptions[cat] ?? '';
                    return (
                        <div className="hidden md:block animate-menu-open absolute left-0 right-0 top-full mt-1 z-30 border-2 border-black rounded-lg bg-white shadow-lg max-h-[50vh] overflow-y-auto md:col-span-3">
                            {description && (
                                <div className="px-2 py-1.5 text-[11px] italic text-gray-600 border-b border-black/20">
                                    {description}
                                </div>
